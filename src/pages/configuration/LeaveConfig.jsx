...
export default function LeaveConfig() {
  ...
  async function handleSave(e) {
    ...
    try {
      setSaving(true);
      await hrmsService.saveConfig("leave", config);
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 text-xs">
          <div>
            ...
            <input
              ...
              min="0"
              max="30"
              value={config.rules.minimumNoticeDays}
              onChange={(e) =>
                setConfig({
                  ...config,
          ...
          <div>
            ...
            <input
              ...
              min="1"
              max="60"
              value={config.rules.maximumConsecutiveDays}
              onChange={(e) =>
                setConfig({
                  ...config,
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setConfig({
                  ...config,
                  rules: { ...config.rules, approvalLevels: e.target.value },
                })
              }
              className="w-full rounded-xl border border-slate-200 p-2.5 text-xs text-[#00373A] focus:outline-none"
            >
          ...
          <div className="flex items-center justify-between p-3.5 rounded-xl border border-slate-200 bg-slate-50">
            ...
            <input
              type="checkbox"
              checked={config.rules.weekendSandwich}
              onChange={(e) =>
                setConfig({
                  ...config,
          ...
          <div className="flex items-center justify-between p-3.5 rounded-xl border border-slate-200 bg-slate-50">
            ...
            <input
              type="checkbox"
              checked={config.rules.holidaySandwich}
              onChange={(e) =>
                setConfig({
                  ...config,
          ...
          <div className="flex items-center justify-between p-3.5 rounded-xl border border-slate-200 bg-slate-50">
            ...
            <input
              type="checkbox"
              checked={config.rules.allowNegativeBalance}
              onChange={(e) =>
                setConfig({
                  ...config,
